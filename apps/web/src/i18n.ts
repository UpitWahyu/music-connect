...
const dict: Record<Lang, Dict> = {
  id: {
    ...
    moveToEnd: "Lepas di sini untuk pindah ke paling bawah",
    clearQueue: "Kosongkan antrian",
    clearConfirmTitle: "Kosongkan antrian?",
    clearConfirmDesc: "Semua lagu akan dihapus dari antrian. Lagu yang sedang diputar tetap berjalan.",
    clear: "Kosongkan",
    queueCleared: "Antrian dikosongkan",
    queueClearedError: "Gagal mengosongkan antrian",
  ...
  en: {
    ...
    moveToEnd: "Drop here to move to the bottom",
    clearQueue: "Clear queue",
    clearConfirmTitle: "Clear queue?",
    clearConfirmDesc: "All songs will be removed from the queue. The current song keeps playing.",
    clear: "Clear",
    queueCleared: "Queue cleared",
    queueClearedError: "Failed to clear queue",
